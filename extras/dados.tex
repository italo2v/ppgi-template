...
% ---
\titulo{Processamento Seguro em Nuvem de \textit{Smart Meters}}
\autor{Marcos Vinícius Monteiro Araújo}
\local{Rio de Janeiro}
\data{2017}
\orientador{Luiz Fernando Rust da Costa Carmo, Dr.}
\coorientador{Charles Bezerra do Prado, DSc.}
\instituicao{%
